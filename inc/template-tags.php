...
<div class="post-thumbnail">
	...
	<div class="button-group stacked-for-small expanded button-group" style="margin: 0 1rem .5rem 1rem;">
	   <a href="/fifty/" class="button hollow text-center expanded" style=""><?php _e('50 years young: Support Germanna', 'gcc-wp-2018') ?></a>
	</div>
	...
	<div class="button-group stacked show-for-large">
 	<a href="/fifty/" class="button hollow expanded" style=""><?php _e('support germanna', 'gcc-wp-2018') ?></a>
