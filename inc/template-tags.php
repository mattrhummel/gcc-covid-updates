...
<div class="post-thumbnail">
	...
	<div class="button-group stacked-for-small expanded button-group">
			<a href="<?php esc_html__('/admissions/request-information/','gcc-wp-2018'); ?>" class="button primary"><?php _e('future students', 'gcc-wp-2018') ?></a>
		<a href="<?php esc_html__('https://www.apply.vccs.edu/applications/vccs/apply.html?application_id=4084', 'gcc-wp-2018'); ?>" class="button secondary"><?php _e('apply now', 'gcc-wp-2018'); ?></a>
	</div>
	<?php }
	?>
	<?php
	...
	<a href="<?php esc_html__('/admissions/request-information/','gcc-wp-2018'); ?>" class="button primary expanded"><?php _e('future students', 'gcc-wp-2018') ?></a>
