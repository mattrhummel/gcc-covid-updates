...
/**
 * New RN Application Step 1
 * Template for WPForms.
 */
class WPForms_Template_new_rn_application_step_1 extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'New RN Application Step 1';

		// Template slug
		$this->slug = 'new_rn_application_step_1';
	...
	'fields' => array (
		...
		5 => array (
			...
			'choices' => array (
				0 => array (
					'label' => 'Results - TEAS/KAPLAN for ADN & LPN-RN (if applicable), (45% or greater in each category)',
				),
			),
			'required' => '1',
			'choices_images_style' => 'modern',
	...
	'settings' => array (
		'form_title' => 'New RN Application Step 1',
		'submit_text' => 'Submit ',
		...
		'notifications' => array (
			3 => array (
				...
				'email' => '{field_id="3"}',
				'subject' => 'New RN Step 1 Requirements Confirmation',
...
You can continue applying for the RN program by filling out the <a href="https://www.germanna.edu/nursing/application/new-applicant/apply/rn/">full online application</a>.
...
Once you complete the application you will receive further instruction on how to become a RN nursing student.

<strong>Sincerely</strong>,
GermannaCC Nursing Staff

--
This e-mail was sent from the Germanna Nursing Application <a href="https://germanna.edu">Germanna.EDU</a>',
				'conditional_logic' => '1',
				'conditional_type' => 'go',
				'conditionals' => array (
					0 => array (
			...
			1 => array (
				...
				'subject' => 'RN Verification "{field_id="2"} {field_id="12"}"',
...
This e-mail was sent from the Germanna Nursing Application <a href="https://germanna.edu">Germanna.EDU</a>',
		...
		'confirmation_redirect' => 'https://www.germanna.edu/nursing/application/new-applicant/rn/confirmation/',
	),
	'meta' => array (
		'template' => 'new_rn_application_step_1',
	),
);
	}
}
new WPForms_Template_new_rn_application_step_1;
endif; ?>
