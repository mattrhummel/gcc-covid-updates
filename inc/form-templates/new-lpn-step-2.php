...
/**
 * New LPN Application Step 2
 * Template for WPForms.
 */
class WPForms_Template_new_lpn_application_step_2 extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'New LPN Application Step 2';

		// Template slug
		$this->slug = 'new_lpn_application_step_2';
...
<p>Misrepresentation on the application will result in dismissal from the Nursing Program.</p>',
	...
	'settings' => array (
		'form_title' => 'New LPN Application Step 2',
		...
		'notifications' => array (
			1 => array (
				...
				'subject' => 'LPN Applicant Results "{field_id="1"} {field_id="2"}"',
...
--
This e-mail was sent from the Germanna Nursing Application for new lpn applicants on <a href="https://germanna.edu">Germanna.EDU</a>',
			),
			2 => array (
				'notification_name' => 'Student',
				'email' => '{field_id="7"}',
				'subject' => 'Germanna LPN Application Confirmation',
...
<p>Thank you for your application to the LPN program. You have indicated that all of the needed elements for your application are on file at Germanna.</p>
...
This e-mail was sent from the Germanna Nursing Application on <a href="https://germanna.edu">Germanna.Edu</a>',
		...
		'confirmation_message' => 'Thank you for applying to Germanna\'s LPN Program. Please check your confirmation email for further steps.',
		'confirmation_message_scroll' => '1',
		'confirmation_page' => '25',
		'confirmation_redirect' => 'https://www.germanna.edu/nursing/application/new-applicant/apply/lpn/confirmation/',
	),
	'meta' => array (
		'template' => 'new_lpn_application_step_2',
	),
);
	}
}
new WPForms_Template_new_lpn_application_step_2;
endif; ?>
