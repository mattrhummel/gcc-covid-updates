...
/**
 * A&P Recognition Award
 * Template for WPForms.
 */
class WPForms_Template_ap_recognition_award extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'A&P Recognition Award';

		// Template slug
		$this->slug = 'ap_recognition_award';
	...
	'fields' => array (
		...
		22 => array (
			'id' => '22',
			'type' => 'html',
			'code' => '<p>Recognition Awards are given to employees with a commitment to excellence.	Please describe specifically how your nominee demonstrated one or more of the following:</p>
<ol>
<li>Going above and beyond job by doing more or better than would usually be expected.</li>
<li>Exemplary behaviors of accountability, innovation, collaboration, teamwork initiative, positive attitude, integrity, good citizenship, and/or sense of public responsibility.</li>
<li>Performance of an exceptional deed or service that contributes to student success, a sense of community at the College, or supports the College’s mission.</li>
<li>Displaying evidence of work that promotes respect, diversity, and individual dignity throughout the college.</li>
</ol>
',
			'label_disable' => '1',
		),
	...
	'settings' => array (
		'form_title' => 'A&P Recognition Award',
		'submit_text' => 'Submit',
		...
		'notifications' => array (
			1 => array (
				...
				'subject' => 'New Entry: A&P Recognition Award',
...
new WPForms_Template_ap_recognition_award;
endif; ?>
