...
/**
 * Reapplying LPN Application Step 2
 * Template for WPForms.
 */
class WPForms_Template_reapplying_lpn_application_step_2 extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'Reapplying LPN Application Step 2';

		// Template slug
		$this->slug = 'reapplying_lpn_application_step_2';
...
<p>Misrepresentation on the application will result in dismissal from the Nursing Program.</p>',
	...
	'settings' => array (
		'form_title' => 'Reapplying LPN Application Step 2',
		...
		'notifications' => array (
			1 => array (
				...
				'subject' => 'Reapplying LPN Applicant "{field_id="1"} {field_id="2"}"',
			...
			2 => array (
				...
				'email' => '{field_id="7"}',
				'subject' => 'Reapplying LPN Applicant "{field_id="2"} {field_id="1"}"',
...
This e-mail was sent from the Germanna Nursing Application on <a href="https://www.germanna.edu">Germanna.Edu</a>',
		...
		'confirmation_redirect' => 'https://www.germanna.edu/nursing/application/reapplying-applicant/apply/lpn/confirmation/',
	),
	'meta' => array (
		'template' => 'reapplying_lpn_application_step_2',
	),
);
	}
}
new WPForms_Template_reapplying_lpn_application_step_2;
endif; ?>
