...
/**
 * New RN Application Step 2
 * Template for WPForms.
 */
class WPForms_Template_new_rn_application_step_2 extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'New RN Application Step 2';

		// Template slug
		$this->slug = 'new_rn_application_step_2';
...
<p>Misrepresentation on the application will result in dismissal from the Nursing Program.</p>',
	...
	'settings' => array (
		'form_title' => 'New RN Application Step 2',
		...
		'notifications' => array (
			1 => array (
				...
				'subject' => 'RN Applicant Results "{field_id="2"} {field_id="1"}"',
...
This e-mail was sent from the Germanna Nursing Application	on <a href="https://germanna.edu">Germanna.EDU</a>',
			...
			2 => array (
				...
				'email' => '{field_id="7"}',
				'subject' => 'Germanna RN Application Confirmation',
...
This e-mail was sent from the Germanna Nursing Application on <a href="https://germanna.edu">Germanna.Edu</a>',
		...
		'confirmation_redirect' => 'https://www.germanna.edu/nursing/application/new-applicant/apply/rn/confirmation/',
	),
	'meta' => array (
		'entry_columns' => array (
			0 => 1,
		...
		'template' => 'new_rn_application_step_2',
	),
);
	}
}
new WPForms_Template_new_rn_application_step_2;
endif; ?>
