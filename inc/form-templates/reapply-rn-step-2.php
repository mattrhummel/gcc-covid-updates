...
/**
 * Reapplying RN Application Step 2
 * Template for WPForms.
 */
class WPForms_Template_reapplying_rn_application_step_2 extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'Reapplying RN Application Step 2';

		// Template slug
		$this->slug = 'reapplying_rn_application_step_2';
...
<p>Misrepresentation on the application will result in dismissal from the Nursing Program.</p>',
	...
	'settings' => array (
		'form_title' => 'Reapplying RN Application Step 2',
		...
		'notifications' => array (
			1 => array (
				...
				'subject' => 'Reapplying RN Applicant "{field_id="2"} {field_id="1"}"',
			...
			2 => array (
				...
				'email' => '{field_id="7"}',
				'subject' => 'Reapplying RN Application Confirmation',
				'sender_name' => 'Germanna Nursing',
				'sender_address' => 'No_Reply_Germanna@germanna.edu',
				'replyto' => 'nursing@germanna.edu',
...
<p>Thank you for your application to the RN program. You have indicated that all of the needed elements for your application are on file at Germanna.</p>
...
--
This e-mail was sent from the RN Online Application on <a href="https://www.germanna.edu">Germanna.Edu</a>',
			),
		),
		'confirmation_type' => 'redirect',
		'confirmation_message' => 'Thank you for applying to Germanna\'s RN Program. Please check your confirmation email for further steps.',
		'confirmation_message_scroll' => '1',
		'confirmation_page' => '25',
		'confirmation_redirect' => 'https://www.germanna.edu/nursing/application/reapplying-applicant/apply/rn/confirmation/',
	),
	'meta' => array (
		'entry_columns' => array (
			0 => 1,
		...
		'template' => 'reapplying_rn_application_step_2',
	),
);
	}
}
new WPForms_Template_reapplying_rn_application_step_2;
endif; ?>
