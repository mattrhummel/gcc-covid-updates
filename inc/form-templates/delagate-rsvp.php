 ...
 */
class WPForms_Template_delagate_rsvp extends WPForms_Template {
	...
	public function init() {
		...
		// Template name
		$this->name = 'Delagate rsvp';

		// Template slug
		$this->slug = 'delagate_rsvp';
	...
	'fields' => array (
		...
		4 => array (
			'id' => '4',
			'type' => 'text',
			'label' => 'Delegate\'s Middle Initial',
			'size' => 'medium',
		...
		8 => array (
			'id' => '8',
			'type' => 'text',
			'label' => 'Year Institution Founded',
			'size' => 'medium',
			'css' => 'wpforms-one-third',
		),
		9 => array (
	...
	'settings' => array (
		...
		'confirmation_redirect' => 'https://www.germanna.edu/inauguration/delegate-rsvp/confirmation/',
	),
	'meta' => array (
		'template' => 'delagate_rsvp',
	),
);
	}
}
new WPForms_Template_delagate_rsvp;
endif; ?>
