...
register_sidebar(array(
		...
		'description' => __( 'Drag widgets to this sidebar container.', 'gcc-wp-2018' ),
		'before_widget' => '<div class="widget" style="background-color: #000000;">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
));
...
register_sidebar(array(
	'id' => 'faculty-widgets',
	'name' => __( 'Faculty Sidebar widgets', 'gcc-wp-2018' ),
	'description' => __( 'Drag widgets to this sidebar container.', 'gcc-wp-2018' ),
	'before_widget' => '<div class="widget">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
...
register_sidebar(array(
		'id' => 'planned-giving-widgets',
		'name' => __( 'Planned Giving Sidebar', 'gcc-wp-2018' ),
		'description' => __( 'Drag widgets to this sidebar container.', 'gcc-wp-2018' ),
		'before_widget' => '<div class="widget">',
		'after_widget' => '</div>',
		'before_title' => '<h3>',
