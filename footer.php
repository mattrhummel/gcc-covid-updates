...
<div id="request-info-form" class="reveal" data-reveal="" data-open="request-info-form" aria-labelledby="request-info-formHeader">
   ...
   <?php do_shortcode('[wpforms id="27548"]'); ?>
