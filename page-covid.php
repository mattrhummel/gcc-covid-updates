...
<ul class="no-bullet">
  <?php echo do_shortcode( '[ajax_load_more id="8325301004" container_type="div" paging="true" paging_classes="pagenation" paging_show_at_most="3" paging_controls="true" paging_previous_label="<" paging_next_label=">" post_type="covid_19" posts_per_page="3" placeholder="true"]' ); ?>
</ul>
